...
export function BienvenidaGenerator() {
  ...
  return (
    <div className="rounded-xl bg-zinc-900 border border-white/[0.06] p-6 space-y-5">
      <div className="flex items-center gap-2">
        <Sparkles className="w-4 h-4 text-cyan-400" />
        <h2 className="text-sm font-semibold text-white">Generar mensaje de bienvenida</h2>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-md bg-zinc-800 border border-zinc-700/50 text-sm text-white px-3 py-2 placeholder-zinc-600 focus:outline-none focus:ring-1 focus:ring-cyan-400/40"
          />
        </div>
        <div className="space-y-1.5">
          <label className="text-xs text-zinc-400">Persona de contacto</label>
          <input
            type="text"
        ...
        <div className="space-y-1.5 sm:col-span-2">
          <label className="text-xs text-zinc-400">Servicio contratado *</label>
          <input
            type="text"
        ...
        <div className="space-y-1.5">
          <label className="text-xs text-zinc-400">Fecha de inicio</label>
          <input
            type="date"
      ...
      {content && (
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <p className="text-xs text-zinc-400">Mensaje generado</p>
            <button
              type="button"
              onClick={handleCopy}
          ...
          <textarea
            ...
            rows={8}
            className="w-full rounded-md bg-zinc-800 border border-zinc-700/50 text-sm text-zinc-100 px-3 py-2.5 resize-none focus:outline-none focus:ring-1 focus:ring-cyan-400/40"
          />
        </div>
      )}
    </div>
