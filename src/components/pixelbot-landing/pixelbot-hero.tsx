      ...
      <div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-10">
          <div className="text-center lg:text-left">
            <p className="inline-flex items-center rounded-full border border-primary/25 bg-primary/10 px-4 py-1.5 text-xs sm:text-sm font-medium tracking-wide text-brand dark:border-cyan-500/25 dark:bg-cyan-500/10">
              {HERO.eyebrow}
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <a
                href="#planes"
                className="group inline-flex items-center gap-2 text-sm font-semibold text-foreground/80 hover:text-brand transition-colors"
              >
                {HERO.ctaPrimary}
            ...
            <a
              href="#como-funciona"
              className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-muted-foreground hover:text-brand transition-colors"
            >
              {HERO.ctaSecondary}
