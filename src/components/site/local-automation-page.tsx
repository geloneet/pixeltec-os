    ...
    <div className="min-h-screen bg-background text-foreground pt-32 sm:pt-40 pb-16 sm:pb-24">
      ...
      <main className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a
            href={city.externalSource.href}
            target="_blank"
            rel="noopener"
            className="mt-4 inline-flex items-center font-medium text-primary dark:text-cyan-400 hover:underline"
          >
            Fuente: {city.externalSource.label} →
          </a>
        </motion.section>
