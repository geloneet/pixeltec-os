...
const SLUG = 'consultoria-bahia-de-banderas';
const SERVICE_HREF = '/services/consultoria';
const SERVICE_LABEL = 'Consultoría Tecnológica Estratégica';
...
export default function Page() {
  ...
  return (
    <>
      ...
      <LocalServicePage city={city} serviceHref={SERVICE_HREF} serviceLabel={SERVICE_LABEL} ctaVerb="modernizar tu operación" />
    </>
  );
}
