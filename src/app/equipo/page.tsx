      ...
      <main className="min-h-screen bg-background dark:bg-[#030303] text-foreground dark:text-white pt-32 sm:pt-40 pb-16 sm:pb-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          ...
          <section className="mb-20">
            <h2 className="text-xs font-semibold text-muted-foreground dark:text-zinc-500 uppercase tracking-widest mb-8 text-center">
              Fundador
            </h2>
            <div className="bg-card dark:bg-[#0A0A0A] border border-border dark:border-white/5 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center md:items-start gap-8 max-w-2xl mx-auto">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-2xl font-bold text-foreground dark:text-white mb-1">Miguel Robles Sánchez</h3>
                <p className="text-brand font-semibold text-sm mb-4">
                  Founder &amp; Lead Software Architect
                </p>
                <p className="text-muted-foreground dark:text-zinc-400 text-sm leading-relaxed mb-6">
                ...
                <div className="flex items-center justify-center md:justify-start gap-4">
                  <Link
                    href="#"
                    className="flex items-center gap-1.5 text-sm text-muted-foreground dark:text-zinc-400 hover:text-foreground dark:hover:text-white transition-colors"
          ...
          {/* Collaborators */}
          <section className="mb-20">
            <div className="bg-card dark:bg-[#0A0A0A] border border-border dark:border-white/5 rounded-2xl p-8 md:p-10 text-center md:text-left max-w-2xl mx-auto">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                <div className="p-2.5 rounded-lg bg-muted dark:bg-zinc-900 border border-border dark:border-zinc-800">
                  <Users className="h-5 w-5 text-muted-foreground dark:text-zinc-400" />
                </div>
          ...
          {/* Hiring CTA */}
          <section>
            <div className="bg-gradient-to-tr from-primary/5 via-card to-card dark:from-cyan-950/50 dark:via-[#0A0A0A] dark:to-[#0A0A0A] border border-border dark:border-white/10 rounded-2xl p-8 md:p-10 text-center max-w-2xl mx-auto">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="p-2.5 rounded-lg bg-muted dark:bg-zinc-900 border border-border dark:border-zinc-800">
                  <Wrench className="h-5 w-5 text-brand" />
                </div>
                <h2 className="text-lg font-bold text-foreground dark:text-white">¿Quieres unirte?</h2>
              </div>
              <p className="text-muted-foreground dark:text-zinc-400 text-sm leading-relaxed mb-6">
                ...
                <Link
                  href="/contact"
                  className="text-brand hover:text-brand/80 dark:hover:text-cyan-300 underline underline-offset-4 transition-colors"
                >
                  escríbenos
                </Link>
                .
