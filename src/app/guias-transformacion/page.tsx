...
export default function GuiasTransformacionPage() {
  return (
    <>
      <Header />
      <div className="min-h-screen bg-background dark:bg-[#030303] text-foreground dark:text-white pt-32 sm:pt-40 pb-16 sm:pb-24">
            ...
            {guidesData.map((guide, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 rounded-full bg-primary/10 dark:bg-cyan-500/10 flex items-center justify-center mb-6 border border-primary/20 dark:border-cyan-500/20">
                    <guide.icon className="w-6 h-6 text-brand" />
                  </div>
                  
                  <p className="text-brand text-xs font-bold tracking-[0.2em] uppercase mb-4">
                    Reporte Exclusivo
                  </p>
                  
                  <h3 className="text-2xl md:text-3xl font-bold text-foreground dark:text-white leading-tight mb-4">
                    {guide.title}
                  </h3>
                ...
                <div className="relative z-10 mt-8">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-background dark:bg-[#030303] border border-border dark:border-white/10 text-muted-foreground dark:text-zinc-500 py-3 md:py-4 rounded-xl cursor-not-allowed transition-all duration-300 font-bold"
                  >
