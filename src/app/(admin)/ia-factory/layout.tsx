...
/**
 * Guard de módulo oculto (WO-2026-00088, patrón único): «Plantillas» responde 404
 ...
 */
export default function PlantillasModuleLayout({ children }: { children: ReactNode }) {
  assertModuleRouteEnabled("plantillas");
  return <>{children}</>;
}
