  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      ...
      >
        ...
        <div className="mt-2 flex items-center justify-between font-roboto text-xs text-muted-foreground">
          <span>Usado</span>
      ...
      >
        <div className="flex items-center justify-between font-roboto text-xs text-muted-foreground">
          <span>En uso</span>
