...
/**
 * Guard de módulo oculto (WO-2026-00088, patrón único): «Blog anterior» responde 404
 ...
 */
export default function BlogLegacyModuleLayout({ children }: { children: ReactNode }) {
  assertModuleRouteEnabled("blog-legacy");
  return <>{children}</>;
}
