...
/**
 * Guard de módulo oculto (WO-2026-00088, patrón único): «Campañas» responde 404
 ...
 */
export default function CampanasModuleLayout({ children }: { children: ReactNode }) {
  assertModuleRouteEnabled("campanas");
  return <>{children}</>;
}
