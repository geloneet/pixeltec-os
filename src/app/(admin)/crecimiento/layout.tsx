...
/**
 * Guard de módulo oculto (WO-2026-00088, patrón único): «Marketing» responde 404
 ...
 */
export default function MarketingModuleLayout({ children }: { children: ReactNode }) {
  assertModuleRouteEnabled("marketing");
  return <>{children}</>;
}
