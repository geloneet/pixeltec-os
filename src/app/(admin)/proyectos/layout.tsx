...
/**
 * Guard de módulo oculto (WO-2026-00088, patrón único): «Trabajo / Proyectos» responde 404
 ...
 */
export default function ProyectosModuleLayout({ children }: { children: ReactNode }) {
  assertModuleRouteEnabled("proyectos");
  return <>{children}</>;
}
