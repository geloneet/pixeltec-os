...
/**
 * Guard de módulo oculto (WO-2026-00088, patrón único): «Definición de proyectos» responde 404
 ...
 */
export default function DefinicionModuleLayout({ children }: { children: ReactNode }) {
  assertModuleRouteEnabled("definicion");
  return <>{children}</>;
}
