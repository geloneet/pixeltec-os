...
- Cualquier campo \`href\` debe ser seguro: solo rutas internas que empiecen con "/" (nunca con un segundo carácter "/" o barra invertida, que el navegador resuelve como URL externa) o URLs externas "https://" — JAMÁS anclas internas "#" (ningún block emite id=, así que nunca resuelven; si una sección no tiene destino real, omite el enlace), NI "javascript:" ni ningún otro esquema.
...
- Concisión obligatoria en el copy de \`propsJson\`: los titulares tienen como máximo 12 palabras; los párrafos/descripciones como máximo 40 palabras; los bullets/etiquetas como máximo 10 palabras. El copy de landing es denso y vendedor — cada palabra gana su lugar; el relleno diluye el mensaje. Nada de markdown dentro de los props. \`notas\` como máximo 120 palabras.
