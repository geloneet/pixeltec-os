...
// El render de markdown liviano (renderRichText/renderInline) vive en
// richtext.mjs, compartido con render-contract.mjs — los estilos se inyectan
// más abajo, después de StyleSheet.create.
...
const styles = StyleSheet.create({
  ...
  code: { fontWeight: 600, color: COLOR.primary },
