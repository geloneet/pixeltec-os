...
Navegación visible: **Inicio · Clientes · WhatsApp · Finanzas · Blog · Usuarios y Accesos** (Blog → `/blog-cms`, FASE 8). PixelBot conserva su acceso (item «PixelBot» → `/whatsapp`, Console dentro de la página) como excepción explícita. Ocultos: Trabajo/Proyectos, Definición, PixelForge, Marketing, Contenido, Campañas, Calendario, Publicaciones, Configuración de marca, Infraestructura, Plantillas, Archivo documental. Legacy: Blog anterior (`/blog-admin`). Transversales sin cambio: Notificaciones, Perfil, Respuestas Smile More.
