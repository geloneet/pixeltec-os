...
| /services | hub servicios | investigación comercial | agencia desarrollo web y automatización | consideration | contacto | optimizada 2026-09-14 (WO-2026-00352) | página de conversión #1; hoy 'use client' completa. Title «Servicios de desarrollo web, IA y consultoría» en `src/app/services/layout.tsx` (antes «Servicios · Soluciones de alto impacto», sin intención); description y H1 sin cambios |
| /services/ecosistemas-web | servicio | investigación comercial | desarrollo web empresarial nextjs | consideration | contacto | optimizada 2026-09-14 (WO-2026-00352) | evidencia real pendiente. Title «Desarrollo Web y Apps a la Medida» (`metaTitle` en `[slug]/page.tsx`); el nombre visible «Ecosistemas Web Avanzados» se conserva en breadcrumb y schema `name` |
| /services/automatizacion | servicio | investigación comercial | automatización de procesos con ia | consideration | diagnóstico | optimizada 2026-09-14 (WO-2026-00352) | title «Automatización de Procesos con IA y WhatsApp»; nombre visible sin cambios; conectar con artículos del pilar |
| /services/consultoria | servicio | investigación comercial | consultoría tecnológica pymes | consideration | contacto | optimizada 2026-09-14 (WO-2026-00352) | title «Consultoría Tecnológica para PyMEs»; nombre visible «Consultoría Tecnológica Estratégica» sin cambios |
...
| /blog | listado | informacional | blog tecnología para pymes | awareness | suscripción (futuro) | optimizada 2026-09-14 (WO-2026-00345) | CollectionPage + breadcrumb; title «Blog: IA, software y automatización para pymes» (antes 79 chars con doble separador) |
| /blog/[slug] | artículo | informacional | por artículo (seo.primaryKeyword) | awareness→consideration | diagnóstico/contacto | optimizar | plantilla renovada; desde 2026-09-14 el bloque «Recursos de PixelTEC mencionados» cae a `src/lib/blog/cluster-map.ts` (categoría + etiquetas) cuando el post no trae `internalLinks` — mapa query→post→servicio en CONTENT-STRATEGY-90-DAYS.md |
| /industrias | hub de industrias | investigación comercial | software para [industria] | consideration | diagnóstico por sector | optimizada 2026-09-14 (WO-2026-00345) | 6 sectores con cliente real; claims corregidos contra `03_CLIENTES` (sin SAT/tracking/pasarelas/portal del paciente/reportes de ocupación/SaaS); registro `src/lib/content/industrias.ts`; BreadcrumbList + ItemList (solo las 2 páginas propias) |
| /industrias/clinicas-dentales | página de industria | consideration → decision | software para clínicas dentales | consideration→decision | diagnóstico (`industry=clinica`) | creada 2026-09-14 (WO-2026-00345) | caso real Smile More (Guadalajara y Guamúchil); Service + FAQPage + BreadcrumbList; enlaza `/desarrollo-web-guadalajara` y `/automatizacion-guadalajara` |
| /industrias/hoteles | página de industria | consideration → decision | sistema de reservas para hoteles · crm hotelero | consideration→decision | diagnóstico (`industry=hotel`) | creada 2026-09-14 (WO-2026-00345) | caso real Villa Nogal (San Sebastián del Oeste, Jalisco — nunca «en Puerto Vallarta»); vigilar canibalización con `/desarrollo-web-puerto-vallarta` (sector vs. ciudad) en el informe GSC semanal |
| /industrias/<bloque sin página> | — | — | — | — | — | 404 a propósito | `dynamicParams=false`: logística, agua, moda y solar son bloques del hub hasta tener caso documentado con alcance real |
| /diagnostico | herramienta | transaccional | diagnóstico madurez digital | decision | wizard | existente | conversión propia del OS |
| /about · /equipo · /metodologia | confianza | navegacional | pixeltec · estudio de software puerto vallarta | consideration | contacto | /about optimizada 2026-09-14 (title WO-2026-00345 · H1 WO-2026-00352) | E-E-A-T: /equipo debe sostener las bios de autor del blog. /about: title «Quiénes somos · Software en Puerto Vallarta»; H1 «Quiénes somos: arquitectos de software en Puerto Vallarta» en `about/page.tsx` (antes «Arquitectos de la Innovación Tecnológica.») |
| /contact | conversión | transaccional | contacto pixeltec | decision | form | description optimizada 2026-09-14 | NAP consistente con site-config; sin `LocalBusiness` esqueleto desde L1 (la entidad local es `#organization`) |
