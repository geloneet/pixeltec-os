...
| /services | hub servicios | investigación comercial | agencia desarrollo web y automatización | consideration | contacto | optimizar (BLOQUEADO hasta el merge de PR #136) | página de conversión #1; hoy 'use client' completa. **Propuesta post-merge (WO-2026-00345 L3):** title «Servicios: desarrollo web, automatización con IA y consultoría» en `src/app/services/layout.tsx` (hoy «Servicios · Soluciones de alto impacto», sin intención) |
| /services/ecosistemas-web | servicio | investigación comercial | desarrollo web empresarial nextjs | consideration | contacto | optimizar (BLOQUEADO hasta el merge de PR #136) | evidencia real pendiente. **Propuesta post-merge:** title con intención («Desarrollo web y apps a la medida») en lugar de la jerga «Ecosistemas Web Avanzados» |
...
| /about · /equipo · /metodologia | confianza | navegacional | pixeltec · estudio de software puerto vallarta | consideration | contacto | /about optimizada 2026-09-14 (title «Quiénes somos · Software en Puerto Vallarta») | E-E-A-T: /equipo debe sostener las bios de autor del blog. **Pendiente post-merge PR #136:** H1 de /about («Arquitectos de la Innovación Tecnológica.») → «Quiénes somos: arquitectos de software en Puerto Vallarta» (vive en `about/page.tsx`) |
